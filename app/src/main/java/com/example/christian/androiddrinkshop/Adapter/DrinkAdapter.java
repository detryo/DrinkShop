...
public class DrinkAdapter extends RecyclerView.Adapter<DrinkViewHolder>{
    ...
    private void showConfirmDialog(final int position, final String number) {
        ...
        final TextView txt_prduct_price = (TextView) itemView.findViewById(R.id.txt_cart_product_price);
        TextView txt_sugar = (TextView) itemView.findViewById(R.id.txt_sugar);
        TextView txt_icer = (TextView) itemView.findViewById(R.id.txt_ice);
        ...
        txt_icer.setText(new StringBuilder("Ice: ").append(Common.ice).append("%").toString());
        ...
        for (String line: Common.toppingAdd)
        ...
        txt_prduct_price.setText(new StringBuilder("£").append(finalPrice));
        builder.setNegativeButton("CONFIRM", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                try {
                    ...
                    cartItem.price = finalPrice; // Pon price
