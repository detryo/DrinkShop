...
public class HomeActivity extends AppCompatActivity
    ...
    private void getToppingList() {
        ...
        compositeDisposable.add(mServices.getDrinik(Common.TOPPING_MENU_ID)
    ...
    private void getMenu() {
        ...
        compositeDisposable.add(mServices.getMenu()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void getBannerImage() {
        ...
        compositeDisposable.add(mServices.getBanners()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void displayImage(List<Banner> banners) {
        ...
        for (String name: bannerMap.keySet())
        {
            ...
            textSliderView.description(name)
                    .image(bannerMap.get(name)).setScaleType(BaseSliderView.ScaleType.Fit);
